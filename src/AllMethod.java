...
public class AllMethod {
    ...
    public   void replacefile(int number){
        File folder = new File("webfiles");
    ...
    public  void commonmethod(AudioInputStream appendFiles){
        try {
    ...
    public  void generatefile1(int number){
        File folder = new File("webfiles");
        File[] listofFiles = folder.listFiles();
        ...
        if(number >= 100 && number<1000){
            ...
            commonmethod(appendFiles);
        }
    }

    public  void generatefile2(int number){
        File folder = new File("webfiles");
        File[] listofFiles = folder.listFiles();
    ...
    public  void generatedfile3(int number){
        File folder = new File("webfiles");
        File[] listofFiles = folder.listFiles();
        if(number >= 100000 && number <10000000){
            ...
            commonmethod(appendFile);

        }
    }

    public   void generatedfile4(int number){
        File folder = new File("webfiles");
        File[] listofFiles = folder.listFiles();
